...
export function SettingsForm({
  ...
  return (
    <form action={formAction} noValidate>
      ...
      {mode !== 'invoice' && (
        <>
          <input type="hidden" name="default_vat_percentage" value={settings?.default_vat_percentage ?? 21} />
          <input type="hidden" name="default_payment_term_days" value={settings?.default_payment_term_days ?? 30} />
